                            ...
                            <tbody>
                                @foreach ($classmeet as $data)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($data->image)
                                                <img src="{{ Storage::url($data->image) }}" alt="Classmeet Image"
                                                    width="80px">
                                            @else
                                                Tidak ada gambar
                                            @endif
                                    ...
                                    <div id="editModal{{ $data->id }}" class="modal fade" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('classmeet.update', $data->id) }}"
                        ...
                        <div id="createModal" class="modal fade" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('classmeet.store') }}" enctype="multipart/form-data"
                                        method="POST">
                                        @csrf
                                        <div class="modal-body">
                                            <div class="mb-3">
