<x-guest>
    ...
    <section
        ...
        <div
            ...
            <h1 class="text-6xl xl:text-7xl font-anton mb-4 glow-text tracking-normal uppercase">P5</h1>
        </div>
    </section>
            ...
            @if ($index == 0) xl:col-span-2 @endif
              ...
              @if ($index == 7 || $index == 8) xl:col-span-2 @endif"
                    ...
                    <div
                        ...
                        <h3 class="text-base font-semibold xl:text-lg xl:font-semibold xl:mb-2">{{ $p->title }}</h3>
