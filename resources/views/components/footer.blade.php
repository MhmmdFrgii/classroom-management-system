...
<footer id="Footer" class="text-white">
    <div class="mx-auto w-full max-w-screen-xl px-8 py-5 xl:py-5">
        <div class="md:flex md:justify-between">
            <!-- Grid Container -->
            <div class="grid grid-cols-2 gap-5 xl:grid-cols-3 xl:gap-8 items-start">
                <!-- Logo -->
                ...
                <div>
                    ...
                    <ul class="text-gray-400 font-sm">
                        <li class="mb-0 xl:mb-2">
                            <a href="https://www.instagram.com/acetkjthree/?hl=id" class="hover:underline" target="_blank">
                                Instagram
                            </a>
                        </li>
                        <li>
                    ...
                    <ul class="text-gray-400 font-sm">
                        <li class="mb-0 xl:mb-2">
                            <a href="https://www.instagram.com/ekizr_/?hl=id" target="_blank" class="hover:underline">
                                <span class="uppercase font-normal text-sm xl:text-base xl:font-medium">Firgi</span>
                            </a>
                        </li>
                        <li>
                            <a href="https://www.instagram.com/dafyall/?hl=id" target="_blank" class="hover:underline">
                                <span class="uppercase font-normal text-sm xl:text-base xl:font-medium">Satria</span>
                            </a>
                        </li>
                    </ul>
                </div>
