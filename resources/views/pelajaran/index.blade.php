                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="editModalLabel{{ $data->id }}">Edit
                                                        Jadwal Pelajaran
                                                    </h4>
                                                    <button type="button" class="close" data-dismiss="modal"
                                                        aria-hidden="true">×</button>
                                                </div>
                                                <form action="{{ route('jadwal-pelajaran.update', $data->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
                                    ...
                                    <div id="deleteModal{{ $data->id }}" class="modal fade" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p>Apakah Anda yakin ingin menghapus jadwal pelajaran
                                                        "{{ $data->subject }}"?</p>
                                                </div>
                                                <div class="modal-footer">
                                                    <form action="{{ route('jadwal-pelajaran.destroy', $data->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="button" class="btn btn-secondary waves-effect"
