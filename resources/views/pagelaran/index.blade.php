                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($pagelaran as $data)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($data->image)
                                                <img src="{{ Storage::url($data->image) }}" alt="Pagelaran Image"
                                                    width="80px">
                                            @else
                                                Tidak ada gambar
                                            @endif
                                    ...
                                    <div id="editModal{{ $data->id }}" class="modal fade" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('pagelaran.update', $data->id) }}"
                        ...
                        <div class="mt-3 d-flex justify-content-center">
                            {{ $pagelaran->links('pagination::bootstrap-4') }}
                        </div>
                        ...
                        <div id="createModal" class="modal fade" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('pagelaran.store') }}" enctype="multipart/form-data"
                                        method="POST">
                                        @csrf
                                        <div class="modal-body">
                                            <div class="mb-3">
