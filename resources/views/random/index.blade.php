    ...
    <div class="container-fluid">
        ...
        <div class="row">
                ...
                <tbody>
                    @foreach ($random as $data)
                        <tr>
                            ...
                            <td>
                                @if ($data->image)
                                    <img src="{{ Storage::url($data->image) }}" alt="Random Image" width="80px">
                                @else
                                    Tidak ada gambar
                                @endif
                            </td>
                        ...
                        <div id="editModal{{ $data->id }}" class="modal fade" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('random.update', $data->id) }}" enctype="multipart/form-data"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
                        ...
                        <div id="deleteModal{{ $data->id }}" class="modal fade" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <form action="{{ route('random.destroy', $data->id) }}"
            ...
            <div class="mt-3 d-flex justify-content-center">
                {{ $random->links('pagination::bootstrap-4') }}
            </div>
            ...
            <div id="createModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="createModalLabel"
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('random.store') }}" enctype="multipart/form-data" method="POST">
                            @csrf
                            <div class="modal-body">
                                <div class="mb-3">
                                    <label for="title">Title</label>
